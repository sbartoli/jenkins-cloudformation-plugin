...
public class StackBean extends AbstractDescribableImpl<StackBean> {
	...
	public StackBean(String stackName, String description, TemplateLocation awsTemplateLocation,
		...
		this.awsTemplateLocation = awsTemplateLocation;
	...
	public static final class DescriptorImpl extends Descriptor<StackBean>{
		...
		public FormValidation doCheckCloudFormationRecipe(
				...
				@QueryParameter String value) throws IOException {
			if (0 == value.length()) {
				return FormValidation.error("Empty cloudformation template.");
			}
			return FormValidation.ok();
		}
